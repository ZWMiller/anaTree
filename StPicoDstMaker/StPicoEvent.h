...
// For Compatibility with Run 14 AnaTree Maker (Legacy)
// If these are ever used for real, someone screwed up their flags.
  Bool_t isMinBias() { return false; };
  Bool_t isHT()      { return false; };
  Bool_t isMtdTrig()   { return false; };
