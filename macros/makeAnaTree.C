...
void makeAnaTree(const Int_t runnumber=16125039,
  ...
  ePurMaker->addTrigger(500203,0); // BHT0*BBCMB
  ePurMaker->addTrigger(500213,0); // "    "
  ePurMaker->addTrigger(500201,0); // BHT0*VPDMB-5
  ePurMaker->addTrigger(500202,1); // BHT1*VPDMB-30
  //ePurMaker->addTrigger(500206,1); // BHT1*VPDMB-30-nobsmd
  ePurMaker->addTrigger(500205,2); // BHT2*BBCMB
  ...
  if(prodMod==1){
    ...
    if(prodType==0){ // prod low and mid
      treeMaker->setInputRunList("./runNumberList_run15pAu");
      //0 -BHT0, 1-BHT1, 2-BHT2, 3-BHT3, 4-MB
      treeMaker->addTrigger(500203,0); // BHT0*BBCMB
      treeMaker->addTrigger(500213,0); // "    "
      treeMaker->addTrigger(500201,0); // BHT0*VPDMB-5
      treeMaker->addTrigger(500204,1); // BHT1*BBCMB
      treeMaker->addTrigger(500214,1); // BHT1*BBCMB
      treeMaker->addTrigger(500202,1); // BHT1*VPDMB-30
      treeMaker->addTrigger(500206,1); // BHT1*VPDMB-30-nobsmd
      treeMaker->addTrigger(500205,2); // BHT2*BBCMB
