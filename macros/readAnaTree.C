...
StChain *chain;
void readAnaTree(Int_t nEvents = 20000000, const Char_t *inputFile="processedRunsTest.list", const Char_t *outputFile="anaTree.hists.root", int trigSelect = 2, bool mixedEvent=false)
{
