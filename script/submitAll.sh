...
get_file_list.pl -keys 'runnumber' -cond 'production=P16id,trgsetupname=production_pp200trans_2015,filetype=daq_reco_mudst,filename~st_physics,storage=nfs' -limit 0 >& runNumber_$1_$2
